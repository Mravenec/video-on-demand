...
public class Spselectphones extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -835168388;

    /**
     * The parameter <code>users.spSelectPhones.p_user_id</code>.
     */
     ...
     */
    public Spselectphones() {
        super("spSelectPhones", Users.USERS);
