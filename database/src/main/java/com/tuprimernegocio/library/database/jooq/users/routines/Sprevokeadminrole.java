...
public class Sprevokeadminrole extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1201597784;

    /**
     * The parameter <code>users.spRevokeAdminRole.p_user_id</code>.
     */
     ...
     */
    public Sprevokeadminrole() {
        super("spRevokeAdminRole", Users.USERS);
