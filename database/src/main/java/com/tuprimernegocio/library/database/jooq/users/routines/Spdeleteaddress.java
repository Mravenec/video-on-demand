...
public class Spdeleteaddress extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1904817284;

    /**
     * The parameter <code>users.spDeleteAddress.p_user_id</code>.
     */
     ...
     */
    public Spdeleteaddress() {
        super("spDeleteAddress", Users.USERS);
