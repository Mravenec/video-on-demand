...
public class Spgrantuserrole extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -309140572;

    /**
     * The parameter <code>users.spGrantUserRole.p_user_id</code>.
     */
     ...
     */
    public Spgrantuserrole() {
        super("spGrantUserRole", Users.USERS);
